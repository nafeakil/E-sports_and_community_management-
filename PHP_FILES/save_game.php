...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['player_name'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO game_registrations (player_name, selected_game) VALUES (?, ?)");
    ...
    if ($stmt) {
        ...
        echo "<script>alert('Success! Game saved to database.'); window.location.href='register-game.php';</script>";
    } else {
